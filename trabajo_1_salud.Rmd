...
Para este análisis se utiliza la siguiente convención de medidas descriptivas: media (desviación estándar), ejemplo: 1.1 (2.3)

```{r}
media_sd <- function(variable) {
  paste0(round(mean(variable), 4), " (", round(sd(variable), 4), ")", n())
}
