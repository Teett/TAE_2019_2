...
```{r}
agrupamiento_kmeans <- kmeans(db_escolaridad_escalado, centers = k_optimo_kmeans, nstart = 10, iter.max = 15 )
```
...
grupos_barrios <- data.frame(barrio_nombre = rownames(db_escolaridad), grupo = agrupamiento_kmeans$cluster)
