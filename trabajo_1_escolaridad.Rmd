...
ggplot(data = db_escolaridad) +
  geom_histogram(
    mapping = aes(x = proporcion_lectoescritura), 
    binwidth = 0.02)
...
ggplot(data = db_escolaridad) +
  geom_bar(mapping = aes(x = ultimo_nivel_estudio))

ggplot(data = db_escolaridad) +
  geom_bar(mapping = aes(x = tipo_institucion_educativa))

ggplot(data = db_escolaridad) +
  geom_point(mapping = aes(x = proporcion_escolaridad_actual, y = proporcion_lectoescritura))
```
